...
setFrontendImage(URL.createObjectURL(file))
  ...
  return (
    <div className='w-full h-full bg-gradient-to-t from-[black] to-[#030353] flex justify-center items-center flex-col p-[20px] '>
        ...
        <h1 className='text-white mb-[40px] text-[30px] text-center '>Activate Your<span className='text-blue-200'> Intelligence Engine</span></h1>
        <p className='text-white mb-[40px] text-[30px] text-center '>Choose the AI companion that resonates with your<span className='text-blue-200'> Style.</span></p>
...
{selectedImage && <button className='min-w-[500px] h-[50px] mt-[25px] text-black font-semibold cursor-pointer bg-blue-400 rounded-full text-[25px] ' onClick={()=>navigate("/customize2")}>Next</button>}
